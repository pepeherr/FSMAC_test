# x_scripts/generar_traduccion_concreta.rb
# Script para generar YAML de traducción de un elemento concreto buscado
# Ejecutar con: rails runner generar_traduccion_concreta.rb

# Ejecución:

# Ver estadísticas de cuántas traducciones hay
# rails runner generar_traduccion_concreta.rb --stats

# Ver árbol de traducciones
# rails runner generar_traduccion_concreta.rb --tree

# Generar archivo completo (incluye admin)
# rails runner generar_traduccion_concreta.rb mis_traducciones.yml

# Usar nombre por defecto (traducciones_completas.yml)
# rails runner generar_traduccion_concreta.rb

def generate_ready_to_use_yaml(
  terms = [/Procesos relacionados/i],
  replacements = {
    # Términos compuestos (ordenados de más específico a más general)
    /Procesos relacionados/i => "Conflictos relacionados"
    },
