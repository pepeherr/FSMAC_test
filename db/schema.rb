...
ActiveRecord::Schema[7.2].define(version: 2026_03_03_163221) do
  ...
  create_table "decidim_participatory_processes", id: :serial, force: :cascade do |t|
    ...
    t.index ["parent_assembly_id"], name: "index_decidim_participatory_processes_on_parent_assembly_id"
  end
  ...
  create_table "decidim_proposals_proposals", id: :serial, force: :cascade do |t|
    ...
    t.index ["parent_objective_id"], name: "index_decidim_proposals_proposals_on_parent_objective_id"
  ...
  add_foreign_key "decidim_participatory_processes", "decidim_assemblies", column: "parent_assembly_id"
  ...
  add_foreign_key "decidim_proposals_proposals", "decidim_proposals_proposals", column: "parent_objective_id"
