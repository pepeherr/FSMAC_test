...
Rails.application.configure do
  ...
  # Siguiente línea descomentada para edición en tiempo real en collaborativetext
  config.action_cable.disable_request_forgery_protection = true

  # Incluido para edición en tiempo real en collaborativetext: requiere Websockets
